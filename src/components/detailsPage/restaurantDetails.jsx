                ...
                <div>
                    ...
                    <div className='bg-gray-100 w-full h-96 p-5 text-zinc-400'>
                        ...
                        <div className='text-center text-sm'>
                            <p className='font-bold text-black'>For better experience, download the Swiggy app now</p>
                        </div>

                        <div className='flex gap-4 justify-center items-center mt-4'>
                            <a href='https://play.google.com/store/apps/details?id=in.swiggy.android&referrer=utm_source%3Dswiggy%26utm_medium%3Dheader' className=' cursor-pointer'>
                            ...
                            <a href='https://apps.apple.com/in/app/swiggy-food-grocery-dineout/id989540920' className=' cursor-pointer'>
